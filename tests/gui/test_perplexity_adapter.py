...
pytest.importorskip(
    'agentdebug.gui.perplexity_adapter',
    reason='needs the gui-app extra',
)

from agentdebug.gui.perplexity_adapter import (  # noqa: E402
    PerplexityResponsesAdapter,
    _anthropic_msgs_to_responses_input,
    _anthropic_tools_to_responses,
    _responses_output_to_anthropic,
)
from agentdebug.gui.together_adapter import (  # noqa: E402
    AnthropicResponse,
    TextBlock,
    ToolUseBlock,
)
...
class TestAdapterMessagesCreateWiring:
    ...
    def test_create_forwards_system_as_instructions(self, monkeypatch) -> None:
        ...
        from agentdebug.gui.perplexity_adapter import _PerplexityMessagesNamespace
