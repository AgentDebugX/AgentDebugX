...
pytest.importorskip('streamlit', reason='needs the gui-app extra')


def test_annotation_only_trial_loads_tasks_and_trajectory(tmp_path, monkeypatch):
    from agentdebug.gui.vis import debugger_app as app
...
def test_step_status_display_uses_plain_readable_text():
    from agentdebug.gui.vis.debugger_app import step_status_display
