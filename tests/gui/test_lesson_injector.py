...
pytest.importorskip(
    'agentdebug.gui.memory.lesson_injector',
    reason='needs the gui-memory extra',
)

from agentdebug.gui.memory.lesson_injector import (  # noqa: E402
    CompositeSelector,
    LessonInjector,
)
from agentdebug.gui.memory.lesson_memory import Lesson  # noqa: E402
from agentdebug.gui.taxonomy import (  # noqa: E402
    ALL_SUBTYPES,
    TAXONOMY_SUBTYPES,
)
...
class TestLessonInjectorTableShape:
    ...
    def test_all_31_codes_and_5_categories_present(self) -> None:
        ...
        for prefix in self._CATEGORY_PREFIX_MAP.values():
