...
pytest.importorskip(
    'agentdebug.gui.tools.lesson_explorer',
    reason='needs the gui-memory extra',
)

from agentdebug.gui.dispatch import dispatch_tool  # noqa: E402
from agentdebug.gui.memory.lesson_memory import Lesson  # noqa: E402
from agentdebug.gui.tools.lesson_explorer import (  # noqa: E402
    follow_episodic_ref,
