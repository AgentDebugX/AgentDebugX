"""Unit tests for agentdebug.gui.evolving.runner helpers (no real API calls)."""
from unittest.mock import patch, MagicMock
from pathlib import Path

from agentdebug.gui.evolving.runner import (
    format_taxonomy_state,
    run_evolving_rca_on_case,
)
from agentdebug.gui.evolving.state import TaxonomyState
from agentdebug.gui.evolving.protocol import EvolvingOp
...
def test_run_evolving_rca_on_case_mocked(tmp_path: Path):
    ...
    with patch("agentdebug.gui.evolving.runner.IngestionResult.from_directory", return_value=fake_ir), \
         patch("agentdebug.gui.evolving.runner.run_react_loop",
