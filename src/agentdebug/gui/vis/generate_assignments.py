...
Usage:
    python -m agentdebug.gui.vis.generate_assignments <trial_dir> [--annotators a b c d e]

Example:
    python -m agentdebug.gui.vis.generate_assignments results/debugger_results/test-1
    python -m agentdebug.gui.vis.generate_assignments results/debugger_results/test-1 --annotators Alice Bob Carol Dave Eve
"""
