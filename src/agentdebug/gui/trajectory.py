...
def load_trajectory(traj_dir: Path) -> dict:
    ...
    # Try loading optional task metadata when a task_metadata tree is present
    # in the working directory, matching the pipeline's other cwd-relative
    # defaults (trajectory_dir / output_dir).
