...
from agentdebug.diagnose.actions.integrations.claude_skill import (
...
from agentdebug.diagnose.actions.integrations.debug_skill import (
    DebugSkillBundle,
    SkillPlatform,
    build_debug_skill_bundle,
    write_debug_skill_bundle,
)
from agentdebug.diagnose.actions.integrations.openhands import (
    OpenHandsBridge,
