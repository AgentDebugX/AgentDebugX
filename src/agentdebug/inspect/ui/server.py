    ...
    '<div class="continuation-shell" role="dialog" aria-modal="true" aria-label="Rerun from event workspace">' +
      ...
      '<div class="continuation-body">' +
        '<div class="continuation-builder">' +
          ...
          '<div class="composer-section"><div class="continuation-label">Rerun API Key</div><input class="composer-input" id="continuation-api-key" type="password" value="' + escapeHtml(backendConfig.api_key || '') + '" placeholder="sk-..."></div>' +
